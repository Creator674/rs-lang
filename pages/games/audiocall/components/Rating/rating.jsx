...
export class Rating extends React.Component {
  ...
  render(){
   return (
            <form className="header_column__level"    
                  onSubmit={this.handleFormSubmit} >
                
                  <input type="radio" name="rating" id="step6" value="l6" 
                         checked={this.state.selectedOption === "l6"}
                         onChange={ this.handleOptionChange} />
               <label for="step6">6 </label> 
                
                  <input type="radio" name="rating" id="step5" value="l5" 
                        checked={this.state.selectedOption === "l5"}
                        onChange={this.handleOptionChange}/>
               <label for="step5">5 </label> 
               
                  <input type="radio" name="rating" id="step4" value="l4" 
                        checked={this.state.selectedOption === "l4"}
                        onChange={this.handleOptionChange}/>
                 <label for="step4">4</label> 
                
                  <input type="radio" name="rating" id="step3" value="l3" 
                         checked={this.state.selectedOption === "l3"}
                         onChange={this.handleOptionChange}/>
               <label for="step3">3 </label> 
                
                  <input type="radio" name="rating" id="step2" value="l2" 
                        checked={this.state.selectedOption === "l2"}
                        onChange={this.handleOptionChange}/>
                <label for="step2">2</label> 
               
                  <input type="radio" name="rating" id="step1" value="l1"
